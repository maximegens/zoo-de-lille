...
public class RemplirBdd {
	...
	public static void ajouterDesAnimaux(){
		...
		Animal alpaga = new Animal("Alpaga",  animalCategories_dico.get("Mamifère"), countries_dico.get("Australie"), "Ceci est un lion féroce", "jungle", "5 a 10 ans", 1, 125, 9,"alpage1,alpage2", enclosures_dico.get("Terre d'Asie"));
		Animal capucinBrun = new Animal("Capucin brun", animalCategories_dico.get("Mamifère"), countries_dico.get("Congo"), "Ceci est un perroquet féroce", "arbres ou en cage", "5 a 10 ans", 1, 12, 5, "capucin1", enclosures_dico.get("Volières"));
		Animal capybara = new Animal("Capybara", animalCategories_dico.get("Mamifère"), countries_dico.get("Brésil"), "Ceci est un lion féroce", "jungle", "5 a 10 ans", 1, 125, 9, "capybara", enclosures_dico.get("Terre d'Afrique"));
		Animal chatPecheur = new Animal("Chat pêcheur", animalCategories_dico.get("Mamifère"), countries_dico.get("Brésil"), "Ceci est un perroquet féroce", "arbres ou en cage", "5 a 10 ans", 1, 12, 5, "chatpecheur11", enclosures_dico.get("Terre d'Asie"));
		Animal coatiBrun = new Animal("Coati brun", animalCategories_dico.get("Mamifère"), countries_dico.get("Brésil"), "Ceci est un lion féroce", "jungle", "5 a 10 ans", 1, 125, 9, "coatibrun1", enclosures_dico.get("Terre d'Amérique"));
		Animal gibbonAMainsBlanches = new Animal("Gibbon à mains blanches", animalCategories_dico.get("Mamifère"), countries_dico.get("Australie"), "Ceci est un perroquet féroce", "arbres ou en cage", "5 a 10 ans", 1, 12, 5, "gibbonmb1", enclosures_dico.get("Terre d'Afrique"));
		Animal elandDuCap = new Animal("Eland du Cap", animalCategories_dico.get("Mamifère"), countries_dico.get("Canada"), "Ceci est un lion féroce", "jungle", "5 a 10 ans", 1, 125, 9, "elan1", enclosures_dico.get("Terre d'Amérique"));
		Animal kinkajou = new Animal("Kinkajou", animalCategories_dico.get("Mamifère"), countries_dico.get("Brésil"), "Ceci est un perroquet féroce", "arbres ou en cage", "5 a 10 ans", 1, 12, 5, "alpage1", enclosures_dico.get("Terre d'Afrique"));
		Animal lievreDePatagonie = new Animal("Lièvre de Patagonie", animalCategories_dico.get("Mamifère"), countries_dico.get("Brésil"), "Ceci est un lion féroce", "jungle", "5 a 10 ans", 1, 125, 9, "alpage1", enclosures_dico.get("Terre d'Afrique"));
		Animal lorisLentPygmee = new Animal("Loris lent pygmée", animalCategories_dico.get("Mamifère"), countries_dico.get("Brésil"), "Ceci est un perroquet féroce", "arbres ou en cage", "5 a 10 ans", 1, 12, 5, "alpage1", enclosures_dico.get("Terre d'Afrique"));
		Animal makiCatta = new Animal("Maki catta", animalCategories_dico.get("Mamifère"), countries_dico.get("Australie"), "Ceci est un lion féroce", "jungle", "5 a 10 ans", 1, 125, 9, "alpage1", enclosures_dico.get("Terre d'Amérique"));
		Animal mangousteJaune = new Animal("Mangouste jaune", animalCategories_dico.get("Mamifère"), countries_dico.get("Australie"), "Ceci est un perroquet féroce", "arbres ou en cage", "5 a 10 ans", 1, 12, 5, "alpage1", enclosures_dico.get("Madagascar"));
		Animal ouistitiDeGeoffroy = new Animal("Ouistiti de Geoffroy", animalCategories_dico.get("Mamifère"), countries_dico.get("Australie"), "Ceci est un lion féroce", "jungle", "5 a 10 ans", 1, 125, 9, "alpage1", enclosures_dico.get("Ile des singes"));
		Animal pandaRoux = new Animal("Panda roux", animalCategories_dico.get("Mamifère"), countries_dico.get("Australie"), "Ceci est un perroquet féroce", "arbres ou en cage", "5 a 10 ans", 1, 12, 5, "alpage1", enclosures_dico.get("Terre d'Asie"));
		Animal petitChevrotainMalais = new Animal("Petit chevrotain malais", animalCategories_dico.get("Mamifère"), countries_dico.get("Australie"), "Ceci est un lion féroce", "jungle", "5 a 10 ans", 1, 125, 9, "alpage1", enclosures_dico.get("Terre d'Afrique"));
